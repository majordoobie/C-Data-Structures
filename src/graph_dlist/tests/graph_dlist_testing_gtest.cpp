...
void free_payload(void *data) { free(data); }
...
protected:
  void SetUp() override {
    ...
    gnode_t *node0 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(0));
    gnode_t *node1 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(1));
    gnode_t *node2 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(2));
    gnode_t *node3 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(3));
    gnode_t *node4 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(4));
    gnode_t *node5 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(5));
    gnode_t *node6 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(6));
    gnode_t *node7 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(7));
    gnode_t *node8 =
        graph_get_node_by_value(this->graph, &this->graph_data.at(8));
  ...
  void TearDown() override { graph_destroy(graph, free_payload); }
};
