...
insert_node(node_t *node, node_payload_t *payload, bst_replace_t replace,
            ...
            void *ptr, avl_tree_t *bst);
static node_t *get_node(avl_tree_t *bst, node_t *node,
                        node_payload_t *target_payload);
static node_t *remove_node(node_t *node, node_payload_t *payload,
                           avl_tree_t *bst);
static void free_all_nodes(avl_tree_t *bst, node_t *node,
