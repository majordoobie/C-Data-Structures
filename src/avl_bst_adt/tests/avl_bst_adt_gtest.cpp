 ...
 * supplied structure
 */
bst_compare_t compare(mock_struct_t *current_payload,
                      mock_struct_t *new_payload) {
...
protected:
  void SetUp() override {
    ...
    bst_insert(tree, create_payload(5, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
    bst_insert(tree, create_payload(4, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
    bst_insert(tree, create_payload(3, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
    bst_insert(tree, create_payload(2, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
    bst_insert(tree, create_payload(1, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
    bst_insert(tree, create_payload(6, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
    bst_insert(tree, create_payload(7, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
    bst_insert(tree, create_payload(8, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
    bst_insert(tree, create_payload(9, nullptr), REPLACE_PAYLOAD_FALSE, nullptr,
               nullptr);
...
TEST_F(TreeTestFixture, TraversalInOrder) {
  ...
  test_traversal_t *test_struct =
      (test_traversal_t *)calloc(1, sizeof(test_traversal_t));
