...
START_TEST(dict_variation_test) {
  ...
  put_key_val_adv(dict, create_intersect_payload(L"Jack", 1), intersect_adv_add,
                  intersect);
  put_key_val_adv(dict, create_intersect_payload(L"Zebra", 1),
                  intersect_adv_add, intersect);
  put_key_val_adv(dict, create_intersect_payload(L"Carillón", 1),
                  intersect_adv_add, intersect);
  put_key_val_adv(dict, create_intersect_payload(L"Chávez", 1),
                  intersect_adv_add, intersect);
  put_key_val_adv(dict, create_intersect_payload(L"Cañoso", 1),
                  intersect_adv_add, intersect);
  put_key_val_adv(dict, create_intersect_payload(L"Côte", 1), intersect_adv_add,
                  intersect);
  put_key_val_adv(dict, create_intersect_payload(L"côTe", 1), intersect_adv_add,
                  intersect);
...
START_TEST(dict_deletion_test) {
  ...
  put_key_val_adv(dict, create_intersect_payload(L"côTe", 2), intersect_adv_add,
                  intersect);
  put_key_val_adv(dict, create_intersect_payload(L"cháVez", 2),
                  intersect_adv_add, intersect);
  put_key_val_adv(dict, create_intersect_payload(L"cháVEZ", 2),
                  intersect_adv_add, intersect);
  put_key_val_adv(dict, create_intersect_payload(L"CariLLón", 2),
                  intersect_adv_add, intersect);
  put_key_val_adv(dict, create_intersect_payload(L"Api2_", 2),
                  intersect_adv_add, intersect);
  ...
  put_key_val_adv(dict, create_intersect_payload(L"cháVEz", 3),
                  intersect_adv_add, intersect);
  put_key_val_adv(dict, create_intersect_payload(L"CaRiLLón", 3),
                  intersect_adv_add, intersect);
...
static TFun creation_default_test[] = {payload_creation_test, dict_create_test,
                                       dict_variation_test, dict_deletion_test,
                                       NULL};
